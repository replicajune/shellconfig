...
if (command -v docker &> /dev/null || command -v podman &> /dev/null); then
  ...
  # auditor
  alias cinc-auditor='docker run --workdir "/srv" -v "${PWD}:/srv" -v "${HOME}/.ssh:/root/.ssh" --entrypoint "/opt/cinc-auditor/bin/cinc-auditor" docker.io/cincproject/auditor:latest'
